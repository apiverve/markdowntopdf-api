...
//
//     MarkdowntoPDFData data = Converter.fromJsonString(jsonString);

package com.apiverve.markdowntopdf.data;
...
public class Converter {
    ...
    public static MarkdowntoPDFData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(MarkdowntoPDFData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(MarkdowntoPDFData.class);
        writer = mapper.writerFor(MarkdowntoPDFData.class);
    }
...
// MarkdowntoPDFData.java

package com.apiverve.markdowntopdf.data;

import com.fasterxml.jackson.annotation.*;

public class MarkdowntoPDFData {
