...
```gradle
dependencies {
    implementation 'com.github.apiverve:markdowntopdf-api:1.1.12'
}
```
...
```java
import com.apiverve.markdowntopdf.MarkdowntoPDFAPIClient;
import com.apiverve.markdowntopdf.APIResponse;
import com.apiverve.markdowntopdf.APIException;

// Initialize the client
MarkdowntoPDFAPIClient client = new MarkdowntoPDFAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/markdowntopdf](https://docs.apiverve.com/ref/markdowntopdf)
...
- **Documentation:** [https://docs.apiverve.com/ref/markdowntopdf](https://docs.apiverve.com/ref/markdowntopdf)
- **Issues:** [GitHub Issues](https://github.com/apiverve/markdowntopdf-api/issues)
