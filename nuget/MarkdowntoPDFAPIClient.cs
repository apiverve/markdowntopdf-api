...
namespace APIVerve.API.MarkdowntoPDF
{
    ...
    /// <summary>
    /// Client for the MarkdowntoPDF API
    /// </summary>
    public class MarkdowntoPDFAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/markdowntopdf";
        ...
        public MarkdowntoPDFAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MarkdowntoPDFAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MarkdowntoPDFAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MarkdowntoPDFQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MarkdowntoPDFQueryOptions options)
        {
        ...
        public ResponseObj Execute(MarkdowntoPDFQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MarkdowntoPDFQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MarkdowntoPDFQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MarkdowntoPDFQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MarkdowntoPDFQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MarkdowntoPDFQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MarkdowntoPDFQueryOptions options)
        {
