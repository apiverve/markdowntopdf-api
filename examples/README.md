# Markdown to PDF API - Examples

This folder contains example code for using the Markdown to PDF API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/markdowntopdf',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/markdowntopdf");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/markdowntopdf](https://docs.apiverve.com/ref/markdowntopdf)
