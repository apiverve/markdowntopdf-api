...
namespace APIVerve\Markdowntopdf;
...
/**
 * Client for the Markdown to PDF API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/markdowntopdf?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/markdowntopdf';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MarkdowntopdfClient] {$message}\n";
        }
    }
}
